...
| 妳接手某聊天室（AI 閉嘴 7 天，或到妳說放行為止） | `接手 #代號` |
| 讓 AI 恢復服務某聊天室 | `放行 #代號` |
...
- **✋ 接手 #代號** → 該聊天室靜音 7 天，AI 在那間房完全不出聲；妳直接開 LINE 手動回。7 天到會自動放行（防妳忘記解除）。
...
**Q. 我想全部放行怎麼辦？**
A. 目前沒做「全部放行」按鈕。靜音的房間 7 天後自動解除；如果要提前放行，回 LINE 一個個打「放行 #代號」。

**Q. 按了接手，但客人沒繼續問怎麼辦？**
A. 沒關係，7 天到會自動解除；期間妳直接開 LINE 手動回覆。
