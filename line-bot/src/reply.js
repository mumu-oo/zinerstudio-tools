...
// 估價轉人工 → 專屬暖罐頭(客人試算機弄不出來或個案才會走到這;順手附試算機/下單頁)
export const ESCALATE_QUOTE_BODY = '你的報價需求我幫你送到 MUMU 桌上囉～想先抓個大概，也可以自己用試算機算算看：https://www.zinerstudio.com/quote／或直接走官網下單頁：https://www.zinerstudio.com/order';
...
- **總價一律不算、不猜、不心算。** 客人問「這個案子多少錢」「幫我估一下」「大概多少」——你的答案永遠是**同一件事**:請他自己用線上試算機算,或直接走官網下單頁:
  ・線上試算機(自己算金額):https://www.zinerstudio.com/quote
  ・官網下單(可以連下單一起完成):https://www.zinerstudio.com/order
  順口告訴他兩個都很直覺、可以自己 DIY 調整條件試看看。
- **絕對不要貼七項表格請客人填**——工具已經在網頁上了,不要在 LINE 上重造。
- 客人若說試算機弄不出來(超出範圍、有特殊需求)、或明確要跟 MUMU 談個案 → 才輸出「${ESCALATE_QUOTE_SENTINEL}」(這個標記客人不會看到,系統會接手回覆)。
